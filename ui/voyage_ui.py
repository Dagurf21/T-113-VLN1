...
class VoyageUI(UIWidget):
    ...
    def create_voyage(self):
        try:
            ...
            departure_time         = self._prompt("Enter time of departure",                         header_title="Create voyage", opt_instruction="Leave empty to cancel")
            return_date            = self._prompt("Enter Return date of voyage",                     header_title="Create voyage", opt_instruction="Leave empty to cancel")
            arrival_departure_time = self._prompt("Enter departure time of arrival flight",          header_title="Create voyage", opt_instruction="Leave empty to cancel")
    ...
    def list_voyages(self):
        ...
        self._display_interactive_datalist(
            { "id": 3, "From": 6, "DEST": 6, "Seats": 5, "Date": 8, "Return date":11, "Status":15 },
            voyage_data,
            title="Voyages"
        )
