...
class FlightRouteData:
    ...
    def create_flight_route(self, flight_route):
        """Writes a new flight route to the storage file"""
    ...
    def get_flight_route(self, flight_route_id):
        """Returns the requested flight_route, if flight_route is not found returns None"""
        with open(self.file_name, newline='', encoding="utf-8") as csvfile:
            reader = csv.DictReader(csvfile)
    ...
    def get_all_flight_routes(self):
        """Returns a list of all flight_routes"""
        ret_list = []
    ...
    def update_flight_route(self, flight_route):
        ...
        with open(self.file_name, 'r', newline='', encoding="utf-8") as csvfile, tempfile:
            ...
            for row in reader:
                # Writes the flight_route with the new data into the temp file
                ...
                # Writes the other flight_routes unchanged 
                else:
